    ...
    <>
      <div className="container contact-page">
        ...
        <div className="info-map">
          ...
          <br />
          <span>ajfoucaultmo@mail.usf.edu</span>
        </div>
        <div className="map-wrap">
          <MapContainer center={[33.680140, -117.896900]} zoom={13}>
            <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
            <Marker position={[33.680140, -117.896900]}>
              <Popup>Alejandro lives here, come over for a cup of coffee :)</Popup>
            </Marker>
          </MapContainer>
        </div>
      </div>
